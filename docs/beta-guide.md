...
> v1.0 release 전 베타 사용자용. **1-2 주 동안 평소 쓰시는 한국어 글에 가끔 적용해보시고 5 분 폼 응답** 만 부탁드려요.
...
#### 강한 캘리브레이션 — Brand voice (Mode D, v0.8 신규)
...
🔗 **[피드백 폼 링크]** — 베타 confirmed 시 메인테이너가 안내 (Google Form).
...
베타 참여해주셔서 감사합니다. 1-2 주 동안의 사용량이 v1.0 안정화 약속의 데이터 베이스가 됩니다. 동의해주시면 v1.0 release 시 README contributor 섹션에 이름 (또는 GitHub username / 닉네임) 표기 — 폼에 동의 옵션이 있어요.
